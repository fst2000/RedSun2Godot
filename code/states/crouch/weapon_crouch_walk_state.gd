class_name WeaponCrouchWalkState

var character
var move_map := {
	Vector2(1,0) : "anim_move/crouch_aim_left",
	Vector2(-1,0) : "anim_move/crouch_aim_right",
	Vector2(0,1) : "anim_move/crouch_aim_forward",
	Vector2(0,-1) : "anim_move/crouch_aim_back"}
...
func next():
	if character.move_direction().length() < 0.01:
		return WeaponCrouchIdleState.new(character)
